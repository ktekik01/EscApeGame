...
public class ScoresMenu implements Screen{
	...
	public void show() {
		...
		table.add("").fillX().uniformX();//from the database best
		table.row();
		table.add("").fillX().uniformX();//from the database second
		table.row();
		table.add("").fillX().uniformX();//from the database third personal records 
		table.row();
